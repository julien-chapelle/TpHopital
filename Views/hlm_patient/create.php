    ...
    <div class="col my-auto cardForm shadow">
        <form method="POST" action="">
            <div class="form-group">
                ...
                <input type="text" class="form-control text-center shadow" id="lastnamePatient" name="lastnamePatient" placeholder="ex: Dupont" value="<?= count($arrayError) != 0 && isset($_POST['addPatient']) ? $_POST['lastnamePatient'] : '' ?>" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control text-center shadow" id="firstnamePatient" name="firstnamePatient" placeholder="ex: Jean" value="<?= !empty($arrayError) && isset($_POST['addPatient']) ? $_POST['firstnamePatient'] : '' ?>" />
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control text-center shadow" id="birthdatePatient" name="birthdatePatient" placeholder="ex: 1990-02-14" value="<?= !empty($arrayError) && isset($_POST['addPatient']) ? $_POST['birthdatePatient'] : '' ?>" />
            ...
            <div class="form-group">
                ...
                <input type="tel" class="form-control text-center shadow" id="phonePatient" name="phonePatient" placeholder="ex: 0614589674" value="<?= !empty($arrayError) && isset($_POST['addPatient']) ? $_POST['phonePatient'] : '' ?>" />
                <p class="errorMessage"><?= isset($arrayError['phonePatient']) ? $arrayError['phonePatient'] : '' ?></p>
            </div>
            <div class="form-group">
                <label for="mailPatient">Mail *</label>
                <input type="email" class="form-control text-center shadow" id="mailPatient" name="mailPatient" placeholder="ex: jean.dupont@gmail.com" value="<?= !empty($arrayError) && isset($_POST['addPatient']) ? $_POST['mailPatient'] : '' ?>" />
